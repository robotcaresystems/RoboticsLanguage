...
#                             '"]|//assign/domain/variable[1][@name="' + variable + '"]')
...
#
#         # save flow on code structure
#         code.xpath('//element/variable[@name="' + variable +
#                    '"]/../Signals/option[@name="rosFlow"]/string')[0].text = flow
#
#       # create assign function to publish automatically
#       if flow in ['outgoing', 'bidirectional']:
#         new_parameters = {}
#         dpath.util.new(new_parameters, '/Transformers/Base/variables/' + variable +
#                        '/assign/post/RosCpp', [variable + '_publisher.publish(' + variable + ');'])
