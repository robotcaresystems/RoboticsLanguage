    ...
    button_view.onclick = function() {
      if (this.network_data == null) {
        ...
        network.on('select', function(params) {
          if (params.nodes == 0) {
            selected_edge_label.innerHTML = 'Transition: ' + +params.edges;
          } else {
            selected_edge_label.innerHTML = 'Node: ' + +params.nodes;
          }
...
selected_edge_label = document.createElement('label')
...
main_element.appendChild(selected_edge_label)
